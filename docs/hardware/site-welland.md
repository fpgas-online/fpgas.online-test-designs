...
### Sqrl Acorn CLE-215+ (×3 deployed, on RPi 5 hosts with mPCIe HAT)

| Host | Switch Port | IP          | RPi MAC           | RPi Model | PCIe Device                                                                    |
| ---- | ----------- | ----------- | ----------------- | --------- | ------------------------------------------------------------------------------ |
| pi2  | port 2      | 10.21.0.102 | 88:a2:9e:45:c6:87 | RPi 5 8GB | `0001:01:00.0 Processing accelerators: Squirrels Research Labs Acorn CLE-215+` |
| pi4  | port 4      | 10.21.0.104 | 88:a2:9e:45:dd:be | RPi 5 8GB | `0001:01:00.0 Processing accelerators: Squirrels Research Labs Acorn CLE-215+` |
| pi6  | port 6      | 10.21.0.106 | 88:a2:9e:45:85:77 | RPi 5 8GB | `0001:01:00.0 Processing accelerators: Squirrels Research Labs Acorn CLE-215+` |
...
- **pi21** (port 21): Cythion/LUNA + Fomu EVT, currently offline.
