...
Standard PMOD pin layouts recommended by TinyTapeout for use on its demo board PMOD headers. These follow the [Digilent PMOD Interface Specification](pmod.md) and are used across the TinyTapeout community to ensure interoperability between designs and peripheral boards.
...
### SPI ([Type 2](pmod.md#type-2--spi-6-pin)) — Bidirectional PMOD
...
### UART ([Type 3](pmod.md#type-3--uart-6-pin)) — Bidirectional PMOD
